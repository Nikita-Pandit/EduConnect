...
//         contact,
//         password,
//         role, // Send the role (student/teacher) in the request
//       });
//       console.log(response);
//       toast.success("Verification email sent! Please check your inbox.", {
//         style: { color: "#ff5722" },
...
//       <div className="flex form-container items-center justify-center">
//         <div
//           className={`border-2 bg-zinc-700 rounded-md p-5 border-blue-300 ${
...
const SignUp = () => {
  ...
  const [contact, setContact] = useState("");
  const [password, setPassword] = useState("");
  // const [role, setRole] = useState("studen"); // Default role
