  ...
  return (
    <div className="min-h-screen bg-[#091024] text-white p-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mt-10 gap-4 md:gap-8">
        ...
        <div className="w-full md:w-96 text-black">
          <Select
           classNamePrefix="react-select"
           
            options={domainOptions}
            onChange={handleDomainChange}
            value={domainOptions.find((opt) => opt.value === domain)}
            isClearable
            ...
            styles={{
              ...
              option: (provided, state) => ({
                ...provided,
                backgroundColor: state.isFocused ? '#3D306F' : '#0B142C',
                color: '#E1C3FF',
                cursor: 'pointer',
              }),
            }}
      ...
      <div className="p-5">
        <div className="flex mt-10 justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8 max-w-6xl">
            {filteredData.length > 0 ? (
              filteredData.map((item, index) => {
                const rank = item.rank?.[studentId] || "N/A";
